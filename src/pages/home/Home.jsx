      ...
      <>
        ...
        <div className="Row">
          <div className="Column">
            ...
            <table>
              <tbody>
                <TopNames names = { boys } top10 ={ top10boys } top100={ top100boys } gender = "m" seeall={ seeAllBoys } changeFavourite= {changeFavourite} />
              </tbody>
            </table>
          ...
          <div className="Column">
            ...
            <table>
              <tbody>
                <TopNames names = { girls }  top10 ={ top10girls } top100={ top100girls } gender = "f" seeall={ seeAllGirls } changeFavourite= {changeFavourite} />
              </tbody>
            </table>
            <div className="text-center">
